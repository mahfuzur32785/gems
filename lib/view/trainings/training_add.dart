                    ...
                    builder: (context, state) {
                      if (state is TrainingDataLoadingState) {
                        ...
                        return Column(children: [
                          ...
                          Padding(
                            ...
                            child: DropdownButtonFormField<dynamic>(
                              ...
                              onChanged: (dynamic newValue) {
                                ...
                                print("asfdasf ${jsonEncode(selectedValue)}");
                          ...
                          venue.isEmpty || venue[0].locationLevel.id == 5
                              ? Container()
                              : Column(
                                  children: [
                                    SizedBox(
                            ...
                            onPressed: () async {
                              ...
                              if (connectivityResult.contains(ConnectivityResult.mobile) ||
                                ...
                                if (_trainingFormKey.currentState!.validate()) {
                                  ...
                                  if(totalParticipantActivationControlleMale.text!=""&&totalParticipantMaintenanceControlleMale.text!=""){
                                  total_male = int.parse(totalParticipantActivationControlleMale.text) +
                                      int.parse(totalParticipantMaintenanceControlleMale
                                          .text);
                                  }
                                  else{
                                    total_male = 0;
                                  ...
                                  if(totalParticipantActivationControlleFemale.text!=""&&totalParticipantMaintenanceControlleFemale.text!=""){
                                  ...
                                  if(totalMinorityMaintenanceControlleMale.text != "" && totalMinorityActivationControlleMale.text != "") {
                                  total_minority_male = int.parse(totalMinorityActivationControlleMale.text) +
                                    ...
                                    total_minority_male = 0;
                                  }

                                  if(totalMinorityActivationControlleFemale.text!="" && totalMinorityMaintenanceControlleFemale.text!="")
                                    {
                                  total_minority_female = int.parse(totalMinorityActivationControlleFemale.text) +
                                    ...
                                    total_minority_female = 0;
                                  }
                                  // total_minority_female = int.parse(totalMinorityActivationControlleFemale.text) + int.parse(totalMinorityMaintenanceControlleFemale.text);
                                  ...
                                  Map trainingBody = {
                                    ...
                                    "training_venue": trainingVenueController
                                        .text,
